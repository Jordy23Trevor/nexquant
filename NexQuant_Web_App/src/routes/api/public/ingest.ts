...
const IngestSchema = z.discriminatedUnion("kind", [
  ...
  z.object({
    ...
    payload: z.object({ 
      ...
      news_sentiment: z.number().optional(),
      fear_greed: z.number().optional(),
      uptime_seconds: z.number().optional(),
      regime: z.string().optional(),
      regime_confidence: z.number().optional(),
      daily_achieved_eur: z.number().optional(),
      daily_target_eur: z.number().optional(),
        ...
        try {
          if (kind === "equity") {
            ...
            await supabaseAdmin.from("bot_status").upsert({
              ...
              ...(payload.kelly_fraction !== undefined ? { kelly_fraction: payload.kelly_fraction } : {}),
              ...(payload.news_sentiment !== undefined ? { news_sentiment: payload.news_sentiment } : {}),
              ...(payload.fear_greed !== undefined ? { fear_greed: payload.fear_greed } : {}),
              ...(payload.uptime_seconds !== undefined ? { uptime_seconds: payload.uptime_seconds } : {}),
              ...(payload.regime !== undefined ? { regime: payload.regime } : {}),
              ...(payload.regime_confidence !== undefined ? { regime_confidence: payload.regime_confidence } : {}),
              ...(payload.daily_achieved_eur !== undefined ? { daily_achieved_eur: payload.daily_achieved_eur } : {}),
              ...(payload.daily_target_eur !== undefined ? { daily_target_eur: payload.daily_target_eur } : {}),
              ...(payload.win_rate !== undefined ? { win_rate: payload.win_rate } : {}),
              ...(payload.profit_factor !== undefined ? { profit_factor: payload.profit_factor } : {}),
              last_heartbeat: new Date().toISOString(),
            });
