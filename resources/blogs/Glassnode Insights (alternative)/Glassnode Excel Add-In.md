...
> Source: https://academy.glassnode.com/integrations-and-tools/glassnode-excel-add-in
> Blog: Glassnode Insights (alternative)
> Catégorie: crypto
> Téléchargé: 2026-06-21

---

For the complete documentation index, see [llms.txt](https://docs.glassnode.com/llms.txt). This page is also available as [Markdown](https://docs.glassnode.com/introduction/readme.md).
...
We recommend using the [CLI](/integrations-and-tools/glassnode-cli) for agentic use cases.
...
👉 [**Getting Started with the API**](/basic-api/api)
...
* [Point-in-Time Metrics](/data/point-in-time-metrics) - Learn about immutable Point-in-Time data used for backtesting.
* [New Data Availability](/data/data-availability) - Understand exactly when new data points appear.
* [FAQ](/further-information/faq) - Find answers to common questions, including how to manage your account and subscription.

[NextChangelog](/introduction/changelog)
