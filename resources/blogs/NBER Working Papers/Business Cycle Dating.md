...
[X](https://twitter.com/intent/?text=Business%20Cycle%20Dating&url=https://www.nber.org/research/business-cycle-dating "X")
[LinkedIn](https://www.linkedin.com/sharing/share-offsite/?url=https://www.nber.org/research/business-cycle-dating "LinkedIn")
[Facebook](https://www.facebook.com/sharer/sharer.php?u=https://www.nber.org/research/business-cycle-dating "Facebook")
[Bluesky](https://bsky.app/intent/compose?text=Business%20Cycle%20Dating+https://www.nber.org/research/business-cycle-dating "Bluesky")
[Threads](https://www.threads.net/intent/post?text=Business%20Cycle%20Dating&url=https://www.nber.org/research/business-cycle-dating "Threads")
[Email](mailto:?subject=Business Cycle Dating&body=https://www.nber.org/research/business-cycle-dating "Email")
Link

---

[*Register for future Business Cycle announcements*]( http://my.nber.org/email_preferences#bcdc-announcements)  
*(account log-in or creation required)*
...
The committee's approach to determining the dates of turning points is retrospective. In making its peak and trough announcements, it waits until sufficient data are available to avoid the need for major revisions to the business cycle chronology. In determining the date of a peak in activity, it waits until it is confident that a recession has occurred. Even in the event that activity began to rise again immediately after the announcement of a peak, the committee would find that a new expansion was underway, and the upturn would not be a continuation of the previous expansion. As a result, the committee tends to wait to identify a peak until a number of months after it has actually occurred. Similarly, in determining the date of a trough, the committee waits until it is confident that an expansion is underway. Even in the event that activity began to decline again immediately, the committee would consider this a new recession, not a continuation of the previous recession. Thus, the committee also waits to identify a trough for a period of time after it has actually occurred.